...
import 'Components/build_app_bar_action.dart';
import 'Screens/Landing Screen/intro_screen.dart';
...
class AppBar extends StatelessWidget {
  const AppBar({
    ...
    required Animation? bgColorTween,
    required Animation? iconColorTween,
  })  : _colorAnimationController = colorAnimationController,
        _bgColorTween = bgColorTween,
        _iconColorTween = iconColorTween,
        super(key: key);

  final AnimationController? _colorAnimationController;
  final Animation? _bgColorTween;
...
class MobileDrawer extends StatelessWidget {
  ...
  final Animation<dynamic>? iconColorTween;

  MobileDrawer({Key? key, this.iconColorTween}) : super(key: key);
